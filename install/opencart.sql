...
CREATE TABLE `oc_category` (
  ...
  `googlebase_text` varchar(255) DEFAULT NULL,
  `googlebase_xml` varchar(255) DEFAULT NULL,
  `status` tinyint(1) NOT NULL,
...
INSERT INTO `oc_category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`, `googlebase_text`, `googlebase_xml`) VALUES
...
CREATE TABLE `oc_product_description` (
  ...
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
  `brief_summary` varchar(255) NOT NULL,
  `meta_title` varchar(255) NOT NULL,
  `meta_description` varchar(255) NOT NULL,
  `meta_keyword` varchar(255) NOT NULL,
  `tag` text NOT NULL,
...
(1,1,'mark.horton','60ae1c44a9d6c53aaeee7cfc0d7f0eca6ce8698b','916d09c6b','Mark','Horton','mark.horton@boundlesscommerce.co.uk','','',1,'2013-01-01 12:00:00'),
...
INSERT INTO `oc_user_group` (`user_group_id`, `name`, `permission`, `superuser`) VALUES
(1, 'Support User', '', 1),
(2, 'Site Admin', '', 0);
...
--
DROP TABLE IF EXISTS `oc_advanced_coupon`;
CREATE TABLE `oc_advanced_coupon` (
...
--
-- Dumping data for table `advanced_coupon`
--
...
--
DROP TABLE IF EXISTS `oc_advanced_coupon_history`;
CREATE TABLE `oc_advanced_coupon_history` (
...
--
-- Dumping data for table `advanced_coupon_history`
--
...
CREATE TABLE IF NOT EXISTS `oc_news_description` (
  ...
  `language_id` int(11) NOT NULL DEFAULT '0',
  `title` varchar(64) CHARACTER SET utf8NOT NULL,
  `description` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `meta_title` varchar(255) CHARACTER SET utf8 NOT NULL,
  `meta_desc` varchar(255) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE `oc_sage_order` (
  ...
  `sage_reference` varchar(64) NOT NULL,
  `sage_status` text NOT NULL,
  `data` blob,
  `order_id` int(11) NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '0',
  `date_added` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
