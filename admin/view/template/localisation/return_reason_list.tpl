          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;">
                <input type="checkbox" name="selected[]" value="<?php echo $return_reason['return_reason_id']; ?>"<?php if ($return_reason['selected']) { ?> checked="checked"<?php } ?>>
							</td>
              <td class="column-name"><?php echo $return_reason['name']; ?></td>
              <td class="column-action">
								<?php echo p3html::tb_action_buttons($return_reason); ?>
							</td>
            </tr>
            <?php } ?>
          </tbody>
