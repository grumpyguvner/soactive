    ...
    <div class="content">
      ...
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list table table-striped table-hover">
          <thead>
            <tr>
              <td class="column-checkbox"><input type="checkbox" onclick="$('input[name*=\'selected\']').attr('checked', this.checked);"></td>
          ...
          <tbody>
            ...
            <tr>
              <td class="column-checkbox">
                <input type="checkbox" name="selected[]" value="<?php echo $stock_status['stock_status_id']; ?>"<?php if ($stock_status['selected']) { ?> checked="checked"<?php } ?>>
							</td>
              <td class="column-name"><?php echo $stock_status['name']; ?></td>
              <td class="column-action">
								<?php echo p3html::tb_action_buttons($stock_status); ?>
							</td>
            </tr>
            <?php } ?>
          </tbody>
