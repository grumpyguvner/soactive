          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;">
                <input type="checkbox" name="selected[]" value="<?php echo $return_status['return_status_id']; ?>"<?php if ($return_status['selected']) { ?> checked="checked"<?php } ?>>
							</td>
              <td class="column-name"><?php echo $return_status['name']; ?></td>
              <td class="column-action">
								<?php echo p3html::tb_action_buttons($return_status); ?>
							</td>
            </tr>
            <?php } ?>
          </tbody>
