          ...
          <tbody>
            ...
            <tr>
              <td class="column-checkbox">
                <input type="checkbox" name="selected[]" value="<?php echo $return_action['return_action_id']; ?>"<?php if ($return_action['selected']) { ?> checked="checked"<?php } ?>>
							</td>
              <td class="column-name"><?php echo $return_action['name']; ?></td>
              <td class="column-action">
								<?php echo p3html::tb_action_buttons($return_action); ?>
							</td>
            </tr>
            <?php } ?>
          </tbody>
