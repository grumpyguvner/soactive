          ...
          <div class="control-group">
            ...
            <div class="controls">
							...
							<div class="language-row<?php if (isset($error_title[$language['language_id']])) { ?> error<?php } ?>">
								<input type="text" name="measurement_class_description[<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($measurement_class_description[$language['language_id']]) ? $measurement_class_description[$language['language_id']]['title'] : ''; ?>" class="span2">
          ...
          <div class="control-group">
            ...
            <div class="controls">
							...
							<div class="language-row<?php if (isset($error_unit[$language['language_id']])) { ?> error<?php } ?>">
								<input type="text" name="measurement_class_description[<?php echo $language['language_id']; ?>][unit]" value="<?php echo isset($measurement_class_description[$language['language_id']]) ? $measurement_class_description[$language['language_id']]['unit'] : ''; ?>" class="span1">
								<i class="flag flag-<?php echo $language['code'];?>"></i>
