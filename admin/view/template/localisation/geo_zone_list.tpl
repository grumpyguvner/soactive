        ...
        <table class="list table table-striped table-hover">
          <thead>
            <tr>
              ...
              <th class="column-name">
								<?php echo p3html::tb_sort_heading($column_description, $sort_description, $sort, $order, 'description'); ?>
							</th>
          ...
          <tbody>
            ...
            <tr>
              <td class="column-checkbox">
                <input type="checkbox" name="selected[]" value="<?php echo $geo_zone['geo_zone_id']; ?>"<?php if ($geo_zone['selected']) { ?> checked="checked"<?php } ?>>
							</td>
              <td class="column-name"><?php echo $geo_zone['name']; ?></td>
              <td class="column-name"><?php echo $geo_zone['description']; ?></td>
              <td class="column-action">
								<?php echo p3html::tb_action_buttons($geo_zone); ?>
							</td>
            </tr>
            <?php } ?>
          </tbody>
