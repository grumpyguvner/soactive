          ...
          <tbody>
            ...
            <tr>
              <td class="column-checkbox">
                <input type="checkbox" name="selected[]" value="<?php echo $weight_class['weight_class_id']; ?>"<?php if ($weight_class['selected']) { ?> checked="checked"<?php } ?>>
							</td>
              <td class="column-name"><?php echo $weight_class['title']; ?></td>
              <td class="column-code"><?php echo $weight_class['unit']; ?></td>
              <td class="column-number"><?php echo $weight_class['value']; ?></td>
              <td class="column-action">
								<?php echo p3html::tb_action_buttons($weight_class); ?>
							</td>
            </tr>
            <?php } ?>
          </tbody>
