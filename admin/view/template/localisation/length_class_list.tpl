          ...
          <tbody>
            ...
            <tr>
              <td class="column-checkbox">
                <input type="checkbox" name="selected[]" value="<?php echo $length_class['length_class_id']; ?>"<?php if ($length_class['selected']) { ?> checked="checked"<?php } ?>>
							</td>
              <td class="column-name"><?php echo $length_class['title']; ?></td>
              <td class="column-code"><?php echo $length_class['unit']; ?></td>
              <td class="column-number"><?php echo $length_class['value']; ?></td>
              <td class="column-action">
								<?php echo p3html::tb_action_buttons($length_class); ?>
							</td>
            </tr>
            <?php } ?>
          </tbody>
