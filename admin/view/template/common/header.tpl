...
if (!defined('P3_CKEDITOR_DIR')) define ('P3_CKEDITOR_DIR', $this->config->get('p3adminrebooted_ckeditor4') ? 'view/js/ckeditor' : 'view/javascript/ckeditor');

if (!defined('P3_UPDATED')) define('P3_UPDATED', 1359608423);// CHANGE THIS TO LAST UPDATED *nix time()
						...
						<ul class="dropdown-menu">
							...
							<li class="dropdown-submenu">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="<?php echo $this->url->link('localisation/order_status_label', 'token=' . $this->session->data['token'], 'SSL');; ?>"><?php echo $text_order_status; ?> - Labels</a></li>
									<li class="dropdown-submenu">
