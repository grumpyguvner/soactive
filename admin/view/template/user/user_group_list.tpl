          ...
          <tbody>
            ...
            <tr>
              <td class="column-checkbox">
                <input type="checkbox" name="selected[]" value="<?php echo $user_group['user_group_id']; ?>"<?php if ($user_group['selected']) { ?> checked="checked"<?php } ?>>
							</td>
              <td class="column-name"><?php echo $user_group['name']; ?></td>
              <td class="column-action">
								<?php echo p3html::tb_action_buttons($user_group); ?>
							</td>
            </tr>
            <?php } ?>
          </tbody>
