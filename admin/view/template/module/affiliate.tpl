                        ...
                        <?php foreach ($modules as $module) { ?>
                            <tr id="module-row<?php echo $module_row; ?>">
                                <td class="column-layout">
                                    ...
                                    <select name="affiliate_module[<?php echo $module_row; ?>][layout_id]" class="span2 i-medium">
                                ...
                                <td class="column-position">
                                    ...
                                    <select name="affiliate_module[<?php echo $module_row; ?>][position]" class="span2 i-medium">
                                        <?php echo p3html::oc_position_options($this->language, $module); ?>
                                    </select>
                                </td>
                                <td class="column-status">
                                    <label class="visible-480"><?php echo $entry_status; ?></label>
                                    <select name="affiliate_module[<?php echo $module_row; ?>][status]" class="input-small">
                                ...
                                <td class="column-sort">
                                    ...
                                    <input type="text" name="affiliate_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" class="span1 i-mini">
                                </td>
...
<script>
    ...
    function addModule() {
        ...
        html += '		<select name="affiliate_module[' + module_row + '][layout_id]" class="span2 i-medium">';
        ...
        html += '		<select name="affiliate_module[' + module_row + '][position]" class="span2 i-medium">';
        ...
        html += '		<select name="affiliate_module[' + module_row + '][status]" class="input-small">';
        html += '			<?php echo p3html::oc_status_options($this->language, null, true); ?>';
        html += '		</select>';
        html += '	</td>';
        html += '	<td class="column-sort"><label class="visible-480"><?php echo addslashes($entry_sort_order); ?></label><input type="text" name="affiliate_module[' + module_row + '][sort_order]" value="" class="span1 i-mini"></td>';
