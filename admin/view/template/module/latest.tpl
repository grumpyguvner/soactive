...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="heading">
      <h1><i class="icon-clock"></i> <?php echo $heading_title; ?></h1>
          ...
          <thead>
           ...
           <tbody>
              ...
              <td class="column-number">
								...
								<input type="text" name="latest_module[<?php echo $module_row; ?>][limit]" value="<?php echo $module['limit']; ?>" class="span1 i-mini">
							</td>
              <td class="column-dimension<?php if (isset($error_image[$module_row])) { ?> error<?php } ?>">
								...
								<input type="text" name="latest_module[<?php echo $module_row; ?>][image_width]" value="<?php echo $module['image_width']; ?>" class="span1 i-mini">
                <input type="text" name="latest_module[<?php echo $module_row; ?>][image_height]" value="<?php echo $module['image_height']; ?>" class="span1 i-mini">
              ...
              <td class="column-layout">
								...
								<select name="latest_module[<?php echo $module_row; ?>][layout_id]" class="span2 i-large">
              ...
              <td class="column-position">
								...
								<select name="latest_module[<?php echo $module_row; ?>][position]" class="span2 i-medium">
                  <?php echo p3html::oc_position_options($this->language, $module); ?>
                </select>
							</td>
              <td class="column-status">
								<label class="visible-480"><?php echo $entry_status; ?></label>
								<select name="latest_module[<?php echo $module_row; ?>][status]" class="input-small">
              ...
              <td class="column-sort">
								...
								<input type="text" name="latest_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" class="span1 i-mini">
							</td>
...
function addModule() {
	...
	html += '    <td class="column-number"><label class="visible-480"><?php echo addslashes($entry_limit); ?></label><input type="text" name="latest_module[' + module_row + '][limit]" value="5" class="span1 i-mini"></td>';
	html += '    <td class="column-dimension"><label class="visible-480"><?php echo addslashes($entry_image); ?></label><input type="text" name="latest_module[' + module_row + '][image_width]" value="80" class="span1 i-mini"> <input type="text" name="latest_module[' + module_row + '][image_height]" value="80" class="span1 i-mini"></td>';
	html += '    <td class="column-layout"><label class="visible-480"><?php echo addslashes($entry_layout); ?></label><select name="latest_module[' + module_row + '][layout_id]" class="span2 i-large">';
	html += '		<?php echo p3html::oc_layout_options($layouts, null, true); ?>';
	html += '    </select></td>';
	html += '    <td class="column-position"><label class="visible-480"><?php echo addslashes($entry_position); ?></label><select name="latest_module[' + module_row + '][position]" class="span2 i-medium">';
	html += '		<?php echo p3html::oc_position_options($this->language, null, true); ?>';
	html += '    </select></td>';
	html += '    <td class="column-status"><label class="visible-480"><?php echo addslashes($entry_status); ?></label><select name="latest_module[' + module_row + '][status]" class="input-small">';
	html += '		<?php echo p3html::oc_status_options($this->language, null, true); ?>';
  html += '    </select></td>';
	html += '    <td class="column-sort"><label class="visible-480"><?php echo addslashes($entry_sort_order); ?></label><input type="text" name="latest_module[' + module_row + '][sort_order]" value="" class="span1 i-mini"></td>';
