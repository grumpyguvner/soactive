          ...
          <tbody>
            ...
            <tr id="module-row<?php echo $module_row; ?>">
              <td class="column-layout">
								...
								<select name="account_module[<?php echo $module_row; ?>][layout_id]" class="span2 i-medium">
              ...
              <td class="column-position">
								...
								<select name="account_module[<?php echo $module_row; ?>][position]" class="span2 i-medium">
                  <?php echo p3html::oc_position_options($this->language, $module); ?>
								</select>
							</td>
              <td class="column-status">
								<label class="visible-480"><?php echo $entry_status; ?></label>
								<select name="account_module[<?php echo $module_row; ?>][status]" class="input-small">
              ...
              <td class="column-sort">
								...
								<input type="text" name="account_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" class="span1 i-mini">
							</td>
...
function addModule() {
	...
	html += '		<select name="account_module[' + module_row + '][layout_id]" class="span2 i-medium">';
	html += '			<?php echo p3html::oc_layout_options($layouts, null, true); ?>';
	html += '		</select>';
	html += '	</td>';
	html += '	<td class="column-position">';
	html += '		<label class="visible-480"><?php echo addslashes($entry_layout); ?></label>';
	html += '		<select name="account_module[' + module_row + '][position]" class="span2 i-medium">';
	...
	html += '		<select name="account_module[' + module_row + '][status]" class="input-small">';
