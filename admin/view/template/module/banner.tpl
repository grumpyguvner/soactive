        ...
        <table id="module" class="list table table-striped table-hover">
          <thead>
            <tr>
              ...
              <th class="column-dimension"><i class="required text-error icon-asterisk"></i> <?php echo $entry_dimension; ?></th>
          ...
          <tbody>
              ...
              <td class="column-name">
								...
								<select name="banner_module[<?php echo $module_row; ?>][banner_id]" class="span3 i-large">
              ...
              <td class="column-dimension<?php if (isset($error_dimension[$module_row])) { ?> error<?php } ?>">
								...
								<input type="text" name="banner_module[<?php echo $module_row; ?>][width]" value="<?php echo $module['width']; ?>" class="span1 i-mini">
                <input type="text" name="banner_module[<?php echo $module_row; ?>][height]" value="<?php echo $module['height']; ?>" class="span1 i-mini">
              ...
              <td class="column-layout">
								...
								<select name="banner_module[<?php echo $module_row; ?>][layout_id]" class="span2 i-medium">
              ...
              <td class="column-position">
								...
								<select name="banner_module[<?php echo $module_row; ?>][position]" class="span2 i-medium">
                  <?php echo p3html::oc_position_options($this->language, $module); ?>
                </select>
							</td>
              <td class="column-status">
								<label class="visible-480"><?php echo $entry_status; ?></label>
								<select name="banner_module[<?php echo $module_row; ?>][status]" class="input-small">
              ...
              <td class="column-sort">
								...
								<input type="text" name="banner_module[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" class="span1 i-mini">
							</td>
...
function addModule() {
	...
	html += '		<select name="banner_module[' + module_row + '][banner_id]" class="span3 i-large">';
	html += '			<?php echo p3html::oc_banner_options($banners, null, true); ?>';
	html += '		</select>';
	html += '	</td>';
	html += '	<td class="column-dimension"><label class="visible-480"><?php echo addslashes($entry_dimension); ?></label><input type="text" name="banner_module[' + module_row + '][width]" value="" class="span1 i-mini"> <input type="text" name="banner_module[' + module_row + '][height]" value="" class="span1 i-mini"></td>';
	html += '	<td class="column-layout">';
	html += '		<label class="visible-480"><?php echo addslashes($entry_layout); ?></label>';
	html += '		<select name="banner_module[' + module_row + '][layout_id]" class="span2 i-medium">';
	...
	html += '		<select name="banner_module[' + module_row + '][position]" class="span2 i-medium">';
	...
	html += '		<select name="banner_module[' + module_row + '][status]" class="input-small">';
	html += '			<?php echo p3html::oc_status_options($this->language, null, true); ?>';
  html += '		</select>';
  html += '	</td>';
	html += '	<td class="column-sort"><label class="visible-480"><?php echo addslashes($entry_sort_order); ?></label><input type="text" name="banner_module[' + module_row + '][sort_order]" value="" class="span1 i-mini"></td>';
