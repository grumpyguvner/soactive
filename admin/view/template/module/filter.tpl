          ...
          <tbody id="module-row<?php echo $module_row; ?>">
            <tr>
              <td class="column-layout">
                    ...
                    <select name="filter_module[<?php echo $module_row; ?>][layout_id]" class="span2 i-medium">
...
function addModule() {
	...
	html += '		<select name="filter_module[' + module_row + '][layout_id]" class="span2 i-medium">';
	html += '			<?php echo p3html::oc_layout_options($layouts, null, true); ?>';
	html += '		</select>';
	html += '	</td>';
	html += '	<td class="column-position">';
	html += '		<label class="visible-480"><?php echo addslashes($entry_layout); ?></label>';
	html += '		<select name="filter_module[' + module_row + '][position]" class="span2 i-medium">';
