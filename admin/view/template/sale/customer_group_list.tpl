          ...
          <thead>
            <tr>
              ...
              <th class="column-name">
								<?php echo p3html::tb_sort_heading($column_name, $sort_name, $sort, $order, 'cgd.name'); ?>
							</th>
              <th class="column-sort">
								<?php echo p3html::tb_sort_heading($column_sort_order, $sort_sort_order, $sort, $order, 'cg.sort_order'); ?>
							</th>
          ...
          <tbody>
            ...
            <tr>
              <td class="column-checkbox">
                <input type="checkbox" name="selected[]" value="<?php echo $customer_group['customer_group_id']; ?>"<?php if ($customer_group['selected']) { ?> checked="checked"<?php } ?>>
							</td>
              <td class="column-name"><?php echo $customer_group['name']; ?></td>
              <td class="column-sort"><?php echo $customer_group['sort_order']; ?></td>
              <td class="column-action">
								<?php echo p3html::tb_action_buttons($customer_group); ?>
							</td>
            </tr>
            <?php } ?>
          </tbody>
