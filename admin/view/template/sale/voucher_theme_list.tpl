          ...
          <tbody>
            ...
            <tr>
              <td class="column-checkbox">
                <input type="checkbox" name="selected[]" value="<?php echo $voucher_theme['voucher_theme_id']; ?>"<?php if ($voucher_theme['selected']) { ?> checked="checked"<?php } ?>>
							</td>
              <td class="column-name"><?php echo $voucher_theme['name']; ?></td>
              <td class="column-action">
								<?php echo p3html::tb_action_buttons($voucher_theme); ?>
							</td>
            </tr>
            <?php } ?>
          </tbody>
