       ...
       <div class="form well">  
        <div class="row">
            ...
            <span class="span2 pull-right" style="text-align:right;">
                    ...
                    <a onclick="location='<?php echo $export; ?>'" class="btn"><span><?php echo $button_export; ?></span></a>
            </span>
      </div>
       </div>   
    <?php if ($coupons) { ?>
      <table class="list table table-striped table-hover">
        <thead>
          <tr>
            ...
            <th class="column-price"><?php echo $column_total_spend; ?></th>
            <th class="column-price"><?php echo $column_total_discount; ?></th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="column-price"><?php echo $coupon['total_spend']; ?></td>
            <td class="column-price"><?php echo $coupon['total_discount']; ?></td>
            <td class="column-action"><?php foreach ($coupon['action'] as $action) { ?>
...
function filter() {
	url = 'index.php?route=report/sale_advanced_coupon&token=<?php echo $token; ?>';
