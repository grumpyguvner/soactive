    ...
    <div class="content">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-module-<?php echo $module_row; ?>" class="vtabs-content">
            ...
            <td><input type="text" name="cron_data[<?php echo $module_row; ?>][name]" value="<?php echo isset($module['name']) ? $module['name'] : ''; ?>" /></td>
          </tr>
              <tr>
                <td><?php echo $entry_description; ?></td>
                <td><textarea name="cron_data[<?php echo $module_row; ?>][description]" rows="8" cols="60" id="description-<?php echo $module_row; ?>"><?php echo isset($module['description']) ? $module['description'] : ''; ?></textarea></td>
              </tr>
            <tr>
              <td><?php echo $entry_status; ?></td>
              <td><select name="cron_data[<?php echo $module_row; ?>][status]">
...
function addModule() {	
	...
	html += '      <td><select name="cron_data[' + module_row + '][status]">';
