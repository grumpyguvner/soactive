            ...
            <table id="option-value<?php echo $option_row; ?>" class="list">
              ...
              <tbody id="option-value-row<?php echo $option_value_row; ?>">
                <tr>
                  ...
                  <td class="left"><input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][ean]" value="<?php echo $product_option_value['ean']; ?>" size="10" /></td>
