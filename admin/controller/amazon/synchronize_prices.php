...
class ControllerAmazonSynchronizePrices extends Controller {
	...
	$this->load->model('localisation/language');
        ...
        $this->data['synchronize'] = $this->url->link('amazon/synchronize_prices/synchronize', 'token=' . $this->session->data['token'], 'SSL');
...
//                        $query = $this->db->query('INSERT INTO `' . DB_PREFIX . 'amazon_products` values ( "' . $this->db->escape($amazonProduct) . '",' . intval($language_id) . ')');
            }
