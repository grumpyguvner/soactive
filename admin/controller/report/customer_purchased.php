<?php
class ControllerReportCustomerPurchased extends Controller { 
	public function index() {   
		$this->load->language('report/customer_purchased');
		...
		if (isset($this->request->get['page'])) {
   		...
   		$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('report/customer_purchased', 'token=' . $this->session->data['token'] . $url, 'SSL'),
      		'separator' => ' :: '
   		);		
		...
		$product_total = $this->model_report_product->getTotalPurchasedByCustomerGroup($data);

		$results = $this->model_report_product->getPurchasedByCustomerGroup($data);
		...
		$pagination->url = $this->url->link('report/customer_purchased', 'token=' . $this->session->data['token'] . $url . '&page={page}');
		...
		$this->data['export'] = $this->url->link('report/customer_purchased/download', 'token=' . $this->session->data['token'] . $url, 'SSL');
		
		$this->template = 'report/customer_purchased.tpl';
		$this->children = array(
			'common/header',
			'common/footer'
		);
	...
	public function download() {
        ...
        $headings[] = $this->language->get('column_group');
        ...
        $this->model_report_export->download('report_customer_purchased', 'Product Purchased by Customer Group Report', $data, $headings, $settings);
