...
class ControllerCommonHeader extends Controller {
    ...
    protected function index() { 
        ...
        $this->data['text_amazon'] = $this->language->get('text_amazon');
	$this->data['text_filter'] = $this->language->get('text_filter');
        ...
        $this->data['text_language_manager'] = $this->language->get('text_language_manager');
        ...
        $this->data['text_report_sale_advanced_coupon'] = $this->language->get('text_report_sale_advanced_coupon');
        ...
        $this->data['text_report_product_stock'] = $this->language->get('text_report_product_stock');
        ...
        $this->data['text_report_customer_purchased'] = $this->language->get('text_report_customer_purchased');
        ...
        $this->data['text_report_register_your_product'] = $this->language->get('text_report_register_your_product');
        ...
        if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
            ...
            $this->data['amazon'] = $this->url->link('extension/amazon', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['language_manager'] = $this->url->link('localisation/language_manager', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['report_sale_advanced_coupon'] = $this->url->link('report/sale_advanced_coupon', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['report_product_stock'] = $this->url->link('report/product_stock', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['report_customer_purchased'] = $this->url->link('report/customer_purchased', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $this->data['report_register_your_product'] = $this->url->link('report/register_your_product', 'token=' . $this->session->data['token'], 'SSL');
