...
class ControllerModuleContact extends Controller {
	...
	public function index() {   
		...
		$this->data['action'] = $this->url->link('module/contact', 'token=' . $this->session->data['token'], 'SSL');
		...
		if (isset($this->request->post['contact_module'])) {
			$this->data['modules'] = $this->request->post['contact_module'];
		} elseif ($this->config->get('contact_module')) { 
			$this->data['modules'] = $this->config->get('contact_module');
		}		
