...
class GoogleMapAPI {
	...
	*/
    ...
    function getOnLoad() {
		...
		return '<script type="text/javascript">window.addEventListener("load",onLoad'.$this->map_id.', false);</script>';                
    }
	...
	function reverseGeoCode($latLng) {
		...
		for($i=0;$i<8;$i++) {
			if(isset($results['results'][0]['address_components'][$i]['types'][0])) {
