...
class InfoPage {
	...
	public $num_links = 10;
	public $url = '';
	public $infotext = 'Showing {start} to {end} of {total} ({pages} Pages)';
	public $style_results = 'results';
	...
	public function render() {
		...
		return '<div class="' . $this->style_results . '">' . str_replace($find, $replace, $this->infotext) . '</div>';
	}
}
?>
