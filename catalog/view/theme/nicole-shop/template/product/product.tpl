...
{?>
		<link href="catalog/view/theme/nicole-shop/js/cloud-zoom.css" rel="stylesheet" type="text/css" />
		<script src="catalog/view/theme/nicole-shop/js/cloud-zoom.1.0.2.min.js" type="text/javascript"></script>		
		<script>
		$.fn.CloudZoom.defaults = {
		  ...
		  { 
			  ...
			  $popup = $image['popup'];
			  $heading_title = $image['heading_title'];
			  $thumb = $image['popup'];
		  }?>
		  <div class="image"><a class="cloud-zoom colorbox" rel="adjustX: 10, adjustY:-4" id='zoom1' href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" /></a></div>
		  <?php if ($images) { ?>
...
<?php }?>			
    ...
    <div class="right">
      ...
      <div class="review">
        <div><img src="catalog/view/theme/nicole-shop/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $reviews; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('a[href=\'#tab-review\']').trigger('click');"><?php echo $text_write; ?></a></div>
			<div class="share">
      ...
      <div class="cart clearfix">
        ...
        <div class="product_wish_compare"><a onclick="addToWishList('<?php echo $product_id; ?>');"><?php echo $button_wishlist; ?></a><br />
...
$('#button-cart').bind('click', function() {
	$.ajax({
		...
		success: function(json) {
			...
			if (json['success']) {
				$('#notification').html('<div class="success" style="display: none;">' + json['success'] + '<img src="catalog/view/theme/nicole-shop/image/close.png" alt="" class="close" /></div>');
...
new AjaxUpload('#button-option-<?php echo $option['product_option_id']; ?>', {
	...
	onSubmit: function(file, extension) {
		$('#button-option-<?php echo $option['product_option_id']; ?>').after('<img src="catalog/view/theme/nicole-shop/image/loading.gif" class="loading" style="padding-left: 5px;" />');
...
$('#button-review').bind('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#review-title').after('<div class="attention"><img src="catalog/view/theme/nicole-shop/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
