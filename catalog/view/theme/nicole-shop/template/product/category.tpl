...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-filter">
    ...
    <div class="display"><a onclick="display('list');"><img src="catalog/view/theme/nicole-shop/image/list.png"><?php echo $text_list; ?></a> <img src="catalog/view/theme/nicole-shop/image/grid.png"> <?php echo $text_grid; ?></div>
...
function display(view) {
	...
	/*	$('.product-list > div').each(function(index, element) {
		...
		$('.display').html('<img src="catalog/view/theme/nicole-shop/image/list.png"><?php echo $text_list; ?> <a onclick="display(\'grid\');"><img src="catalog/view/theme/nicole-shop/image/grid.png"> <?php echo $text_grid; ?></a>');
	...
	/*	$('.product-grid > div').each(function(index, element) {
		...
		*/			
		$('.display').html('<a onclick="display(\'list\');"><img src="catalog/view/theme/nicole-shop/image/list.png"><?php echo $text_list; ?></a>  <img src="catalog/view/theme/nicole-shop/image/grid.png"><?php echo $text_grid; ?>');
