...
if (!isset($_nico_active) || $_nico_active == 'Flexslider') 
{?>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/nicole-shop/stylesheet/flexslider.css"/>
<script src="catalog/view/theme/nicole-shop/js/jquery.easing.1.3.js"  type="text/javascript"></script>
<script src="catalog/view/theme/nicole-shop/js/jquery.flexslider.js"  type="text/javascript"></script>
...
<div class="slideshow">
  ...
  <?php $_slide_counter = 0;if (isset($_nico_settings['slider_text'])) foreach ($_nico_settings['slider_text'] as $index => $slide) { ?>
	<div id="slideshow<?php echo $module; ?>-caption-<?php echo $_slide_counter++;?>" class="nivo-html-caption"><?php echo $slide['title'];?></div>
  <?php }?>
</div>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/nicole-shop/js/nivo-slider.css" media="screen" />
<script src="catalog/view/theme/nicole-shop/js/jquery.nivo.slider.pack.js"></script>
<script type="text/javascript"><!--
$(document).ready(function() {
...
{?>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/nicole-shop/stylesheet/ei-slider.css"/>
<script src="catalog/view/theme/nicole-shop/js/jquery.easing.1.3.js"  type="text/javascript"></script>
<script src="catalog/view/theme/nicole-shop/js/jquery.eislideshow.js" type="text/javascript"></script>
<div class="slideshow">
  <div id="slideshow<?php echo $module; ?>" class="ei-slider" style="width: <?php echo $width; ?>px; height: <?php echo $height; ?>px;">
    ...
    <li>
		...
		<?php if (isset($_nico_settings['slider_text'][$_slide_counter])) {?>
		 <div class="ei-title">
				<?php if (isset($_nico_settings['slider_text'][$_slide_counter]['title'])) {?><h2><?php echo $_nico_settings['slider_text'][$_slide_counter]['title'];?></h2><?php }?>
				<?php if (isset($_nico_settings['slider_text'][$_slide_counter]['subtitle'])) {?><h3><?php echo $_nico_settings['slider_text'][$_slide_counter]['subtitle'];?></h3><?php }?>
				<?php if (isset($_nico_settings['slider_text'][$_slide_counter]['description'])) {?><p><?php echo $_nico_settings['slider_text'][$_slide_counter]['description'];?></p><?php }?>
		</div>
		<?php $_slide_counter++;}?>
    <?php } else { ?>
		 <img src="<?php echo $banner['image']; ?>" alt="<?php echo $banner['title']; ?>" />
...
{?>
	...
	<link rel='stylesheet' id='camera-css'  href='catalog/view/theme/nicole-shop/stylesheet/camera.css' type='text/css' media='all'> 
    <script type='text/javascript' src='catalog/view/theme/nicole-shop/js/jquery.mobile.customized.min.js'></script>
    <script type='text/javascript' src='catalog/view/theme/nicole-shop/js/jquery.easing.1.3.js'></script> 
    <script type='text/javascript' src='catalog/view/theme/nicole-shop/js/camera.js'></script> 
    
	<div class="fluid_container"  id="slideshow<?php echo $module; ?>">
        <div class="camera_wrap camera_emboss">
			<?php $_slide_counter = 0;foreach ($banners as $banner) { ?>
				...
				<?php if (isset($_nico_settings['slider_text'][$_slide_counter])) {?><div class="camera-caption"><?php echo $_nico_settings['slider_text'][$_slide_counter++]['title'];?></div><?php }?>
            </div>
            <?php }?>
        </div>
    </div>
		...
		jQuery(function(){
			jQuery('#slideshow<?php echo $module; ?> > div').camera({
				...
				mobileEasing:"<?php
				 ...
				 ?>",
				animation:"<?php
				 if (isset($_nico_settings['sliders']['Homepage']['Camera slider']['animation']))
				 echo $_nico_settings['sliders']['Homepage']['Camera slider']['animation'];
