...
<?php if ($advanced_coupon_status) { ?>
 ...
 <?php } ?>      
  ...
  <div class="cart-module">
    ...
    <div id="advanced_coupon" class="content">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
            <?php echo $entry_advanced_coupon; ?>&nbsp;
            <input type="text" name="advanced_coupon" value="<?php //echo $advanced_coupon; ?>" />
...
<?php } ?>
<?php if ($next == 'advanced_coupon') { ?>
 $('#use_advanced_coupon').trigger('click');
<?php } ?>
<?php if ($next == 'voucher') { ?>
