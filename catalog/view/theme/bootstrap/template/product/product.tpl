...
<div id="content"><?php echo $content_top; ?>
    ...
    <div class="right">
      ...
      <div class="options">
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <?php } ?>
          <b><?php echo $option['name']; ?>:</b><br />
          <input type="button" class="btn" value="<?php echo $button_upload; ?>" id="button-option-<?php echo $option['product_option_id']; ?>"  class="btn">
      ...
      <div class="cart">
        <div><?php echo $text_qty; ?>
          ...
          &nbsp;
          <input type="button" class="btn" value="<?php echo $button_cart; ?>" id="button-cart" />
        </div>
  ...
  <!-- ------------- Start Bootstrap tab ------------- -->
            ...
            <ul class="nav nav-tabs" id="myTab" style="margin-bottom: 0;">
              <li class="active"><a data-toggle="tab" href="#home"><?php echo $tab_description; ?></a>
              </li>
              <li class=""><a data-toggle="tab" href="#profile"><?php if ($attribute_groups) { ?>
    <?php echo $tab_attribute; ?>
    <?php } ?></a></li>
              <li class=""><a data-toggle="tab" href="#dropdown1"><?php if ($review_status) { ?>
    <?php echo $tab_review; ?>
    <?php } ?></a></li>
