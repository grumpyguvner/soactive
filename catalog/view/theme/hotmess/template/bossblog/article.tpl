    ...
    <div class="article-title">
        ...
        <p><?php echo $title;?></p>
			...
			<div id="productRelated">
				...
				<div class="box-product list_carousel responsive">
					<ul id="product_related">
					<?php foreach ($products as $product) {  ?> 
						<li><div class="relProduct"><div class="boss_hover">
            ...
            <div class="comments">
                ...
                <div class="form-comment-container">
                    ...
                    <div id="0_comment_box" class="form-comment">
                          ...
                          <?php }?>
              	          <div>
                            <div class="left"><a id="button-comment" class="button cst button-boss"><span class="button_fr"><?php echo $button_continue; ?></span></a></div>
                          </div>
                    	  </div>
            	   </div>
