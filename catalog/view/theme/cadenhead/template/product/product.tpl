...
<div id="content"><div id="content_product"><?php echo $content_top; ?>
        ...
        <div class="product-info">
            <?php if ($thumb || $images) { ?>
                <div class="left">
                    <?php if ($thumb) { ?>
                        <div class="caption"><div class="image"><a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="colorbox" rel="colorbox"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" /></a><span><strong><?php if ($stock_quantity <= 10) {
                    echo $stock_quantity . ' ' . 'left!';
                } ?></strong></span></div></div>
                        <?php } ?>
                        <?php if ($images) { ?>
...
<?php } ?>
                <div class="cart">
                    ...
                    <div style="width: 100%;margin-top: 4px;"> <a onclick="addToCompare('<?php echo $product_id; ?>');"><?php echo $button_compare; ?></a></div>
                    <?php if ($minimum > 1) { ?>
