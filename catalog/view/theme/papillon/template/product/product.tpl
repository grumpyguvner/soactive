    ...
    <div class="product-info">
        ...
        <div class="right">
            <div style="min-height: 548px;">
                ...
                <h2><?php echo $text_model; ?> <?php echo $model; ?></h2>
                <?php if ($price) { ?>
                ...
                <div id="tabs_wrapper">
                    <div id="tabs" class="htabs"><a href="#tab-description"><?php echo $tab_description; ?></a>
                        ...
                        <a href="#tab-<?php echo $product_tab['name']; ?>"><?php echo $product_tab['name']; ?></a>
                        <?php } ?>
                        <?php } ?>
                        <?php if ($review_status) { ?>
                    ...
                    <div id="tab_content_wrapper">
                        ...
                        <?php if ($product_tabs) { ?>
                        <?php foreach ($product_tabs as $product_tab) { ?>
                            <div id="tab-<?php echo $product_tab['name']; ?>" class="tab-content"><?php echo $product_tab['text']; ?></div>
                        <?php } ?>
                        <?php } ?>
                        <?php if ($review_status) { ?>
