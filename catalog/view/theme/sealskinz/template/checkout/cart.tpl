...
<div id="content"><?php echo $content_top; ?>
  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
      ...
      <div class="cart-info">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="total">
                <h4 style="font-weight: normal"><?php echo $product['total']; ?></h4>
            </td>
          </tr>
          <?php } ?>
    ...
    <table id="total">
      ...
      <tr style="border: 1px solid #DDDDDD;">
        <td class="right" style="border-right: 1px solid #DDDDDD; background-color: #EEEEEE;"><b><?php echo $total['title']; ?>:</b></td>
  ...
  <div class="buttons">
    <div class="right"><a href="<?php echo $continue; ?>" class="button"><?php echo $button_shopping; ?></a>&nbsp&nbsp<a href="<?php echo $checkout; ?>" class="button"><?php echo $button_checkout; ?></a></div>
