                                 ...
                                 <div id="left">
                                        ...
                                        <div id="submit-wrapper" style="float: left">
                                            <form action="/index.php" method="get" id="newsletter_form" target="_blank">
                                                 ...
                                                 <input type="email" id="submit_review" name="" style="color: white" placeholder="Submit your review"><a href="#"><img src="catalog/view/theme/sealskinz/image/go-button.png" alt="Go Button" /></a>
                                                 </div>
                                            </form>
                                        </div>
                                    </div>
