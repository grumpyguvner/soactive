...
//        $paymentDetails->InsuranceTotal = $insuranceTotal;
            $paymentDetails->ShippingTotal = new BasicAmountType($currencyCode, $this->currency->format($order_info['total'] - $itemTotalValue, $order_info['currency_code'], false, false));
